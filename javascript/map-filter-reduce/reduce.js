...
// const marks = [56, 76, 89, 55, 67];

// const total = marks.reduce((total, current) => {
//   //   console.log(total, current);
//   return total + current;
// }, 0);

// console.log(total);
// console.log(cart.data[0].price);

const cartTotal = cart.data.reduce((total, cartItem) => {
  //   console.log(total, cartItem.price);
